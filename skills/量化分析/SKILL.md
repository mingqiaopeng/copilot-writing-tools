...
| 9 | 正式词比率 | ……% | …… |
| 10 | 四字格密度 | ……‰ | …… |
| 11 | 词长分布 | 单字X% / 双字X% / 三字X% / 四字+X% | …… |
| 12 | 词性分布 | 名词X% / 动词X% / 形X% / 副X% / 虚X% | …… |
| 13 | 段落相似度 | （无高相似段对 / 第X段↔第Y段：……） | …… |
...
- **13 号段落相似度**：若 `paragraphSimilarity.pairs` 为空，写"无高相似度段对"并解读"各段落内容分化良好，无重复"；若存在高相似段对，列出并指出需合并或删除
